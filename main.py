        ...
        while True:
            ...
            for i in xrange(FLAGS.training_iter):
                ...
                def print_result(emo_cause_prf, pair_prf):
                    ...
                    p, r, f1 = pair_prf[:3]
                    print('row pair_prediction: p {:.4f} r {:.4f} f1 {:.4f}'.format(p, r, f1 ))
                    p, r, f1 = pair_prf[3:6]
                    print('col pair_prediction: p {:.4f} r {:.4f} f1 {:.4f}'.format(p, r, f1 ))
                ...
                print('Test emotion_prediction: max_p {:.4f} max_r {:.4f} max_f1 {:.4f}\n'.format(p, r, f1))
